  ...
  return (
    <div className={styles.content}>
      ...
      <div className={styles.content_text_container}>
        ...
        <h2 className={styles.content_h2}>Aerospace Engineering Student</h2>
        <h4 className={styles.content_h4}>University of Colorado Boulder</h4>
        ...
        <div className={styles.content_button_container}>
